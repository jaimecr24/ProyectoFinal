const getState = ({ getStore, getActions, setStore }) => {
  return {
    ...
    actions: {
      ...
      addFavPlace: (idPlace) => {
        return fetch(
          process.env.BACKEND_URL + "/api/favorite/" + idPlace.toString(),
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
      ...
      getBrowsePlace: (key) =>
        fetch(process.env.BACKEND_URL + "/api/browse/" + key),
      ...
      deleteComment: (idComment) => {
        return fetch(
          process.env.BACKEND_URL + "/api/comments-removed/" + idComment,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
        ...
        let markerPositions = [
          {
            ...
            content:
              "<p><b>" + place.name + "</b></p><p>" + place.address + "</p>",
          },
        ];
